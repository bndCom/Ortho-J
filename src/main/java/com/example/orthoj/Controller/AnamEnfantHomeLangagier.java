...
public class AnamEnfantHomeLangagier {
    ...
    public void initialize() {
        stringList = FXCollections.observableArrayList(Main.cabinet.getqLangagier());
    ...
    private void handleSave() throws IOException {
        Main.cabinet.setqLangagier(new ArrayList<>(stringList));
