...
public class AnamEnfantHomeDynamique {
    ...
    public void initialize() {
        stringList = FXCollections.observableArrayList(Main.cabinet.getqDynamique());
    ...
    private void handleSave() throws IOException {
        Main.cabinet.setqDynamique(new ArrayList<>(stringList));
