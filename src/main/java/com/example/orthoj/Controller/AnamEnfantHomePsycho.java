...
public class AnamEnfantHomePsycho {
    ...
    public void initialize() {
        stringList = FXCollections.observableArrayList(Main.cabinet.getqPsycho());
    ...
    private void handleSave() throws IOException {
        Main.cabinet.setqPsycho(new ArrayList<>(stringList));
