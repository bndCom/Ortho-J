...
public class AnamEnfantHomeCondition {
    ...
    public void initialize() {
        stringList = FXCollections.observableArrayList(Main.cabinet.getqCondition());
    ...
    private void handleSave() throws IOException {
        Main.cabinet.setqCondition(new ArrayList<>(stringList));
